...
See the official [User interface guide](https://code.visualstudio.com/docs/getstarted/userinterface) for videos and more information.

![VS Code panel layout](img/VS-Code-panel-layout.png)
